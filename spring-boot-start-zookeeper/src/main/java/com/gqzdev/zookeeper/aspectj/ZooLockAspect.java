package com.gqzdev.zookeeper.aspectj;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.gqzdev.zookeeper.annotation.LockKeyParam;
import com.gqzdev.zookeeper.annotation.ZooLock;
...
public class ZooLockAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(com.gqzdev.zookeeper.annotation.ZooLock)")
    public void doLock() {
